...
CREATE TABLE `block_chain` (
  ...
  `inb_circulation` double unsigned DEFAULT NULL,
...
CREATE TABLE `node` (
  ...
  `reward_account` varchar(256) DEFAULT NULL,
  ...
  `staking_Value`  double DEFAULT NULL DEFAULT '0',
  `time_limited_staking_value` double DEFAULT NULL DEFAULT '0',
  `node_id` varchar(256) DEFAULT NULL,
  `email` varchar(64) DEFAULT NULL,
  `vote_number` double unsigned DEFAULT NULL,
